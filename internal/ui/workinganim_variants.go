// This file is the 10 individual "agent is working" animations
// themselves — see workinganim.go for the shared state/dispatch/tick-loop
// machinery every one of these renders through (workingAnimState.render,
// bgStyle, lerpColor/hexToRGB, ...).
package ui
